function Chips({ title, idprop, handleActive, active }) {
  return (
    ...
    <section
      className={`w-24 h-6  border-[0.5px] rounded-xl flex justify-center items-center text-[10px] uppercase font-semibold cursor-pointer md:text-base md:w-32 md:hover:bg-indigo-50 md:hover:text-black md:active:bg-indigo-200 md:active:text-white ${
        active === idprop
